import { PLACE_TYPES, mapboxReverseSearch } from "./request";

let focused_element_index = 0;

export function createDropdown(mounting_point) {
...
export async function parseMapboxSuggestion(suggestion_data) {
...
export function addSuggestionsToInput(target, dropdown, api_results) {
  dropdown.innerHTML = '';
